# SysOps assignment_50_cent
#### Set up enviorement for Ubuntu 18.04. Prerequisite
1. [Task 0.1 Creating Vagrantfile.](https://github.com/vostapch/test_50_Cent/blob/main/Vagrantfile)
2. [Task 0.2 Provision script will help us to upgrade the env which we set UP](https://github.com/vostapch/test_50_Cent/blob/main/provision/provision.sh)
...
2. [Task 1.2 Creating playbooks with web_server_install.yml ](https://github.com/vostapch/test_50_Cent/blob/main/playbooks/web_server_install.yml)
3. [Task 1.3 Creating roles/apache with defaults directory and main.yml](https://github.com/vostapch/test_50_Cent/blob/main/roles/apache/defaults/main.yml)
